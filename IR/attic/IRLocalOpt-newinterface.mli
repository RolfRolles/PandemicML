...
val replace_instr_var_with_var : (IR.var, IR.var) Hashtbl.t -> IR.instr -> IR.instr
...
val local_dse : IR.instr list -> IR.instr list
...
(** Same as previous function, except it returns a hash table mapping varibles
    to constant values, if the variable was determined to be constant as a 
    result of the optimization. *)
val local_copy_prop_with_v2cmap : IR.instr list -> IR.instr list * ((IR.var, IR.expr) Hashtbl.t)
