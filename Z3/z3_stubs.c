...
int camlidl_transl_table_z3_enum_6[148] = {
  Z3_OP_TRUE,
  Z3_OP_FALSE,
  Z3_OP_EQ,
  Z3_OP_DISTINCT,
...
{
value _v1;
  _v1 = camlidl_find_enum((*_c2), camlidl_transl_table_z3_enum_6, 148, "typedef Z3_decl_kind: bad enum  value");
  return _v1;
}
...
int camlidl_transl_table_z3V3_enum_6[148] = {
  Z3_OP_TRUE,
  Z3_OP_FALSE,
  Z3_OP_EQ,
  Z3_OP_DISTINCT,
...
{
value _v1;
  _v1 = camlidl_find_enum((*_c2), camlidl_transl_table_z3V3_enum_6, 148, "typedef Z3_decl_kind: bad enum  value");
  return _v1;
}

int camlidl_transl_table_z3V3_enum_7[8] = {
  Z3_NO_FAILURE,
  Z3_UNKNOWN,
  Z3_TIMEOUT,
  Z3_MEMOUT_WATERMARK,
...
{
value _v1;
  _v1 = camlidl_find_enum((*_c2), camlidl_transl_table_z3V3_enum_7, 8, "typedef Z3_search_failure: bad enum  value");
  return _v1;
}

int camlidl_transl_table_z3V3_enum_8[4] = {
  Z3_PRINT_SMTLIB_FULL,
  Z3_PRINT_LOW_LEVEL,
  Z3_PRINT_SMTLIB_COMPLIANT,
  Z3_PRINT_SMTLIB2_COMPLIANT,
